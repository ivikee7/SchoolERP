                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Create Sullpier</h3>
                            ...
                            <div class="card-body">
                                <div>
                                    <form action="{{ route('inventry.library.book.supplier.store') }}" method="post" class="form-prevent-multiple-submits">
                                        @csrf
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="supplier_address" value="{{ old('supplier_address') }}"
                                                            placeholder="Address">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            name="supplier_contact" value="{{ old('supplier_contact') }}"
                                                            placeholder="Contact Number">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        <label for="" class="ml-1 mr-1">Contact Numbers</label>
                                                        <input type="number"
                                                            class="form-control @error('supplier_contact2') border border-danger @enderror "
                                                            name="supplier_contact2" value="{{ old('supplier_contact2') }}"
                                                    ...
                                                    <div class="col-md-2 col-sm-12 mt-2">
                                                        ...
                                                        <select name="supplier_status" id=""
                                                            ...
                                                            <option value="1"
                                                                @if (old('supplier_status') == '1') selected @endif>
                                                                Active
                                                            </option>
                                                            <option value="0"
                                                                @if (old('supplier_status') == '0') selected @endif>
                                                                Suspended</option>
                                                        </select>
                                                    </div>
                                                </div>
