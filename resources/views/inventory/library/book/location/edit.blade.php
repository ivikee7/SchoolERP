                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <form action="{{ route('inventry.library.book.location.update', $location->id) }}"
                                        method="post">
                                        @csrf
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="location_name"
                                                            @if (old('location_name')) value="{{ old('location_name') }}"
                                                                @elseif ($location->location_name) value="{{ $location->location_name }}" @endif
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="location_note"
                                                            @if (old('location_note')) value="{{ old('location_note') }}"
                                                                @elseif ($location->location_note) value="{{ $location->location_note }}" @endif
                                                            placeholder="Location Name">
                                                    </div>
                                                </div>
                                            </div>
