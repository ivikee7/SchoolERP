                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <form action="{{ route('inventry.library.book.category.update', $category->id) }}"
                                        method="post">
                                        @csrf
                                        <div class="card">
                                            <div class="card-body">
