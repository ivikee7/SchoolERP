                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <select name="supplier_id" id=""
                                                            ...
                                                            @elseif ($book->supplier_id == $supplier->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_title"
                                                            @if (old('book_title')) value="{{ old('book_title') }}" @elseif ($book->book_title)
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_edition"
                                                            @if (old('book_edition')) value="{{ old('book_edition') }}" @elseif ($book->book_edition)
                                                    ...
                                                    <select name="author_id" id=""
                                                        ...
                                                        <option value="{{ $author->id }}" @if (old('author_id') == $author->id) selected @elseif
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_author"
                                                            @if (old('book_author')) value="{{ old('book_author') }}" @elseif ($book->book_author)
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <select name="publisher_id" id=""
                                                            ...
                                                            @elseif($book->publisher_id == $publisher->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_isbn"
                                                            @if (old('book_isbn')) value="{{ old('book_isbn') }}" @elseif ($book->book_isbn)
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="number" step="0.01"
                                                            ...
                                                            name="book_pages"
                                                            @if (old('book_pages')) value="{{ old('book_pages') }}" @elseif ($book->book_pages)
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <select name="category_id" id=""
                                                            ...
                                                            @elseif($book->category_id == $category->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <select name="language_id" id=""
                                                            ...
                                                            @elseif($book->language_id == $language->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <select name="class_id" id=""
                                                            ...
                                                            @elseif($book->class_id == $class->id) selected @endif>
                                                                        {{ $class->name }}
                                                                    </option>
                                                                @endforeach
                                                            @endif
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <select name="location_id" id=""
                                                            ...
                                                            @elseif($book->location_id == $location->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            name="book_price"
                                                            @if (old('book_price')) value="{{ old('book_price') }}" @elseif($book->book_price)
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_note"
                                                            @if (old('book_note')) value="{{ old('book_note') }}" @elseif($book->book_note)
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            name="purchased_at"
                                                            @if (old('purchased_at')) value="{{ old('purchased_at') }}" @elseif($book->purchased_at)
