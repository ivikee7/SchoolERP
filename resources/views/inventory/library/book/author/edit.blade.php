                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <form action="{{ route('inventry.library.book.author.store') }}" method="post">
                                        @csrf
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="author_name"
                                                            @if (old('author_name')) value="{{ old('author_name') }}"
                                                                @elseif ($author->author_name) value="{{ $author->author_name }}" @endif
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="author_note"
                                                            @if (old('author_note')) value="{{ old('author_note') }}"
                                                                @elseif ($author->author_note) value="{{ $author->author_note }}" @endif
