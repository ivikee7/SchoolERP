                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <form action="{{ route('inventry.library.book.publisher.store') }}" method="post" class="form-prevent-multiple-submits">
                                        @csrf
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="email"
                                                            ...
                                                            name="publisher_email" value="{{ old('publisher_email') }}"
                                                            placeholder="Name">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="publisher_contact" value="{{ old('publisher_contact') }}"
