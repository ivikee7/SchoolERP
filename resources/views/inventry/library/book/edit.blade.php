                                                ...
                                                <div class="row">
                                                            ...
                                                            @if ($suppliers ?? '')
                                                                @foreach ($suppliers as $supplier)
                                                                    <option value="{{ $supplier->id }}" disabled
                                                                        @if (old('supplier_id') == $supplier->id) selected @elseif ($book->supplier_id == $supplier->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_title" disabled
                                                            @if (old('book_title')) value="{{ old('book_title') }}"
                                                            @elseif ($book->book_title) value="{{ $book->book_title }}" @endif
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_edition" disabled
                                                            @if (old('book_edition')) value="{{ old('book_edition') }}"
                                                            @elseif ($book->book_edition) value="{{ $book->book_edition }}" @endif
                                                            placeholder="Edition">
                                                    </div>
                                                    {{-- <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                            ...
                                                            @if ($authors ?? '')
                                                                @foreach ($authors as $author)
                                                                    <option value="{{ $author->id }}"
                                                                        @if (old('author_id') == $author->id) selected @elseif ($book->author_id == $author->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_author" disabled
                                                            @if (old('book_author')) value="{{ old('book_author') }}"
                                                            @elseif ($book->book_author) value="{{ $book->book_author }}" @endif
                                                            placeholder="Author">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <select name="publisher_id" id=""
                                                            ...
                                                            @if ($publishers ?? '')
                                                                @foreach ($publishers as $publisher)
                                                                    <option value="{{ $publisher->id }}" disabled
                                                                        @if (old('publisher_id') == $publisher->id) selected @elseif ($book->publisher_id == $publisher->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_isbn" disabled
                                                            @if (old('book_isbn')) value="{{ old('book_isbn') }}"
                                                            @elseif ($book->book_isbn) value="{{ $book->book_isbn }}" @endif
                                                            placeholder="ISBN">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="book_pages" disabled
                                                            @if (old('book_pages')) value="{{ old('book_pages') }}"
                                                            @elseif ($book->book_pages) value="{{ $book->book_pages }}" @endif
                                                            placeholder="Pages">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                            ...
                                                            @if ($categories ?? '')
                                                                @foreach ($categories as $category)
                                                                    <option value="{{ $category->id }}" disabled
                                                                        @if (old('category_id') == $category->id) selected @elseif ($book->category_id == $category->id) selected @endif>
                                                        ...
                                                        <select name="language_id" id=""
                                                            ...
                                                            @if ($languages ?? '')
                                                                @foreach ($languages as $language)
                                                                    <option value="{{ $language->id }}" disabled
                                                                        @if (old('language_id') == $language->id) selected @elseif ($book->language_id == $language->id) selected @endif>
                                                            ...
                                                            @if ($classes ?? '')
                                                                @foreach ($classes as $class)
                                                                    <option value="{{ $class->id }}" disabled
                                                                        @if (old('class_id') == $class->id) selected @elseif ($book->class_id == $class->id) selected @endif>
                                                                        {{ $class->name }}
                                                                    </option>
                                                                @endforeach
                                                            @endif
                                                            ...
                                                            @if ($subjects ?? '')
                                                                @foreach ($subjects as $subject)
                                                                    <option value="{{ $subject->id }}" disabled
                                                                        @if (old('subject_id') == $subject->id) selected @elseif ($book->subject_id == $subject->id) selected @endif>
                                                            ...
                                                            @if ($locations ?? '')
                                                                @foreach ($locations as $location)
                                                                    <option value="{{ $location->id }}"
                                                                        @if (old('location_id') == $location->id) selected @elseif ($book->location_id == $location->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            name="book_price" disabled
                                                            @if (old('book_price')) value="{{ old('book_price') }}"
                                                            @elseif ($book->book_price) value="{{ $book->book_price }}" @endif
                                                            placeholder="Price">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-2">
                                                        ...
                                                        <input type="text" disabled
                                                            ...
                                                            name="book_note"
                                                            @if (old('book_note')) value="{{ old('book_note') }}"
                                                            @elseif ($book->book_note) value="{{ $book->book_note }}" @endif
                                                            placeholder="Note">
                                                    </div>
                                                </div>
                                            </div>
