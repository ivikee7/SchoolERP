...
(function ($) {
    ...
    $container.append(
        '<h5>Customize Thene</h5><hr class="mb-2"/>'
    )
    ...
    var $dark_mode_checkbox = $('<input />', {
        ...
        if ($(this).is(':checked')) {
            ...
            $('body .wrapper').children('nav:first').removeClass('navbar-light bg-light')
            $('body .wrapper').children('nav:first').addClass('navbar-dark bg-dark')
        } else {
            $('body').removeClass('dark-mode')
            $('body .wrapper').children('nav:first').removeClass('navbar-dark bg-dark')
            $('body .wrapper').children('nav:first').addClass('navbar-light bg-light')
        }
    })
    ...
    // Custom button
    $container.append('<h6>Customize Save</h6>')
    $container.append(
        '<button id="theme-style-save" class="btn btn-primary flex">Save</button><hr class="mb-2"/><button id="theme-style-reset" class="btn btn-primary flex">Reset</button><hr class="mb-2"/>'
    )
